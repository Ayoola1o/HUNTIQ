...
import type { SavedSearchesKpiSummary } from '../../types/savedSearches';

interface SavedSearchesKpiCardsProps {
  summary: SavedSearchesKpiSummary;
  activeFilter: string;
  onSelectFilter: (filter: string) => void;
}

export const SavedSearchesKpiCards: React.FC<SavedSearchesKpiCardsProps> = ({
  summary,
  activeFilter,
  onSelectFilter
}) => {
